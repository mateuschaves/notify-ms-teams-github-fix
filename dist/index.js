...
function createMessageCard(notificationSummary, notificationColor, runNum, runId, repoName, sha, repoUrl, timestamp) {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const messageCard = yield message_card_1.createMessageCard(notificationSummary, notificationColor, runNum, runId, repoName, sha, repoUrl, timestamp);
